...
trait TransformationImplicits {
  ...
  implicit val countryCodesCommonTransitOutsideCommunityList: Transformation[CountryCodesCommonTransitList.type] =
    Transformation
      .fromReads(
        (
  ...
  implicit val transformationCountryCodesCommonTransitList: Transformation[CountryCodesCommonTransitOutsideCommunityList.type] =
    Transformation
      .fromReads(
        (
